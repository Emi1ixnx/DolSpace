...
int eleccion5 = 0; 
    ...
    switch (dolspace) {
                    ...
                    if (eleccion2 == 4){
                        ...
                        if (eleccion3 == 4){
                            ...
                            if (eleccion4 == 4){
                                ...
                                cout << "La voz te pide, llorando y suplicando, por una explicación. Al intentar hablar entre llantos y gritos de la persona al otro lado de la radio, decides\nrevisar lo que han grabado las cámaras";
                                cout << "\nMiras cómo corren tripulantes, desesperados, empujandose unos a otros huyendo; acto seguido, tú, apareciendo con un arma.\n";
                                cout << "¿Por qué lo hiciste?";
        ...
        a = 1 + rand ()%10;
            cout << "<<Haz de 3 a 4 intentos para que funcione correctamente>>\n";
            cout << "Eres un remanente. Escuchas a un tripulante en un rango de 10 pisos\nadivina en dónde se encuentra. Atrápalo\n";
            
            while (respuesta == 0) {
                cout << "Ingresa el número de piso\n";
                cin >> num; 
                ...
                if (num>= 1 && num<= 10){
                    ...
                    if (num>a) {
                        cout << "El civil se encuentra en un piso más abajo\n";
                        
                    }
                        if (num<a) {
                            cout << "El civil se encuentra en un piso más arriba\n"; 
                            
                        }
                        else {
                            cout << "Está ahí, es tuyo" << "\nLo encontraste en " << intentos << " intentos\n";
                            return 0; 
                        }
                        }
                else {
                cout << "¿A dónde vas? el tripulante se encuentra entre los 10 pisos\n";

    ...
    switch (dolspace) {
        ...
        case 1: cout << "Despiertas; toda la tripulación ha muerto, estás vagando solo por el espacio. No queda vida dentro de la nave. No hay luz ni energía.\nContigo portas una Raygun con quince cilindros de munición. Tienes quince disparos. Tu objetivo es escapar de la nave\n";
            ...
            cin >> eleccion; 
                ...
                if (eleccion == 2) {
                    cout << "Nadie responde, al parecer, estás completamente solo\n";          
                    cout << "Munición: "; cout << raygun; 
                }
                if (eleccion == 3) {
                    cout << "Al despertar, te das cuenta que te falta un cilindro\n";
                    raygun = raygun - 1;
                    cout << "Munición: "; cout << raygun; 
                }
                if (eleccion == 4) {
                    ...
                    if (eleccion2 == 4){
                        ...
                        if (eleccion3 == 3){
                            cout <<"Tus pasos, al escucharse con rapidez, la persona piensa que estás yendo hacia ella. Un disparo te roza la pierna. Decides disparar y aciertas\n";
                            raygun = raygun - 1; 
                            cout << "Munición: "; cout << raygun;
                        }
                        if (eleccion3 == 4){
                            ...
                            cout << "El estruendo de los disparos ha alertado a un ente, suena diferente, algo más peligroso; se acerca con rapidez\n";
                            cout << "1: Te escondes en la habitación\n 2: Lo esperas para enfrentarte\n 3: Usas el cuerpo de la persona como carnada\n"; 
                            cin >> eleccion4; 
                            if (eleccion4 == 1){
                            ...
                            if (eleccion4 == 2){
                                cout << "Al pararte a lado de la puerta, esperando a que llegue, disparas dos veces y por golpes sordos sabes que acertaste, pero corres de su presencia.\n";
                                raygun = raygun - 2; 
                                cout << "Munición: "; cout << raygun;
                            }
                            if (eleccion4 == 3){
                            ...
                            if (eleccion4 == 4){
                                ...
                                cout << "\nDas con la ubicación de el generador y entras\n";
                                ...
                                cout << "El switch está en medio de la plaza. Una especie de tubo enorme, contiene en su estructura un simple switch\n";
                                cout << " 1: Ir en sigilo hacia el switch\n 2: Disparar a los remanentes\n 3: Lanzar un cilindro para despistarlos\n 4: Salir del juego\n";
                                cin >> eleccion5;
                                if (eleccion5 == 1){
                                ...
                                cout << "La voz te pide, llorando y suplicando, por una explicación. Al intentar hablar entre llantos y gritos de la persona al otro lado de la radio, decides revisar\nlo que han grabado las cámaras";
                                cout << "Miras cómo corren tripulantes, desesperados, empujandose unos a otros huyendo; acto seguido, apareces con un arma.\n";
                                cout << "Ellos confiaban en ti";

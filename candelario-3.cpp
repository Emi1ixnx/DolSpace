                    ...
                    if (eleccion2 == 4){
                        ...
                        if (eleccion3 == 4){
                            ...
                            if (eleccion4 == 4){
                                ...
                                cout << "\nDas con la ubicación donde se localiza el generador y entras\n";
                                ...
                                cout << "La voz te pide, llorando y suplicando, por una explicación. Al intentar hablar entre llantos de la persona al otro lado de la radio, decides revisar\n lo que han grabado las cámaras";
